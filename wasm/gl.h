...
/*
 * Generated by the following javascript
let arr = []
for (const i in WebGL2RenderingContext.prototype) {
    if (typeof ctx[i] === 'number') {
        arr.push([i, ctx[i]]);
    }
}
arr.sort((a,b) => a[1] - b[1])
arr.map(el => `#define GL_${el[0]} ${el[1]}`).join('\n')
*/
...
#define JS_WEBGL_FN(name)  \
__attribute__((import_module("webgl"))) \
__attribute__((import_name(name))) \
extern

JS_FN("setCurrentWebgl2Canvas") void setCurrentWebgl2Canvas(const char *);

JS_WEBGL_FN("glActiveTexture") void glActiveTexture(GLenum texture);
JS_WEBGL_FN("glAttachShader") void glAttachShader(GLuint program, GLuint shader);
JS_WEBGL_FN("glBindBuffer") void glBindBuffer(GLenum target, GLuint buffer);
JS_WEBGL_FN("glBindFramebuffer") void glBindFramebuffer(GLenum target, GLuint framebuffer);
JS_WEBGL_FN("glBindTexture") void glBindTexture(GLenum target, GLuint texture);
JS_WEBGL_FN("glBindVertexArray") void glBindVertexArray(GLuint array);
JS_WEBGL_FN("glBlendEquation") void glBlendEquation(GLenum mode);
JS_WEBGL_FN("glBlendFunc") void glBlendFunc(GLenum sfactor, GLenum dfactor);
JS_WEBGL_FN("glBufferData") void glBufferData(GLenum target, GLsizeiptr size, const void *data, GLenum usage);
JS_WEBGL_FN("glBufferSubData") void glBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const void *data);
JS_WEBGL_FN("glClear") void glClear(GLbitfield mask);
JS_WEBGL_FN("glClearColor") void glClearColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a);
JS_WEBGL_FN("glClearDepth") void glClearDepth(GLfloat depth);
JS_WEBGL_FN("glCompileShader") void glCompileShader(GLuint shader);
JS_WEBGL_FN("glCreateBuffer") GLuint glCreateBuffer(void);
JS_WEBGL_FN("glCreateFramebuffer") GLuint glCreateFramebuffer(void);
JS_WEBGL_FN("glCreateProgram") GLuint glCreateProgram(void);
JS_WEBGL_FN("glCreateShader") GLuint glCreateShader(GLenum type);
JS_WEBGL_FN("glCreateTexture") GLuint glCreateTexture(void);
JS_WEBGL_FN("glCreateVertexArray") GLuint glCreateVertexArray(void);
JS_WEBGL_FN("glDeleteBuffer") void glDeleteBuffer(GLuint buffer);
JS_WEBGL_FN("glDeleteBuffers") void glDeleteBuffers(GLsizei n, const GLuint *buffers);
JS_WEBGL_FN("glDeleteFramebuffer") void glDeleteFramebuffer(GLuint framebuffer);
JS_WEBGL_FN("glDeleteProgram") void glDeleteProgram(GLuint program);
JS_WEBGL_FN("glDeleteShader") void glDeleteShader(GLuint shader);
JS_WEBGL_FN("glDeleteTexture") void glDeleteTexture(GLuint texture);
JS_WEBGL_FN("glDeleteVertexArray") void glDeleteVertexArray(GLuint array);
JS_WEBGL_FN("glDepthFunc") void glDepthFunc(GLenum func);
JS_WEBGL_FN("glDisable") void glDisable(GLenum cap);
JS_WEBGL_FN("glDrawArrays") void glDrawArrays(GLenum mode, GLint first, GLsizei count);
JS_WEBGL_FN("glDrawElements") void glDrawElements(GLenum mode, GLsizei count, GLenum type, const void *indices);
JS_WEBGL_FN("glEnable") void glEnable(GLenum cap);
JS_WEBGL_FN("glEnableVertexAttribArray") void glEnableVertexAttribArray(GLuint index);
JS_WEBGL_FN("glFramebufferTexture2D") void glFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
JS_WEBGL_FN("glGenBuffers") void glGenBuffers(GLsizei n, GLuint *buffers);
...
JS_WEBGL_FN("glGetError") GLenum glGetError(void);
JS_WEBGL_FN("glGetProgramInfoLog") void glGetProgramInfoLog(GLuint program, GLsizei maxLength, GLsizei *length, GLchar *infoLog);
JS_WEBGL_FN("glGetProgramParameter") GLint glGetProgramParameter(GLuint program, GLenum pname);
JS_WEBGL_FN("glGetProgramiv") void glGetProgramiv(GLuint program, GLenum pname, GLint *params);
JS_WEBGL_FN("glGetShaderInfoLog") void glGetShaderInfoLog(GLuint shader, GLsizei maxLength, GLsizei *length, GLchar *infoLog);
...
JS_WEBGL_FN("glTexParameteri") void glTexParameteri(GLenum target, GLenum pname, GLint param);
JS_WEBGL_FN("glUniform1f") void glUniform1f(GLint location, GLfloat v0);
JS_WEBGL_FN("glUniform1fv") void glUniform1fv(GLint location, GLsizei count, const GLfloat *value);
JS_WEBGL_FN("glUniform1i") void glUniform1i(GLint location, GLint v0);
JS_WEBGL_FN("glUniform1iv") void glUniform1iv(GLint location, GLsizei count, const GLint *value);
JS_WEBGL_FN("glUniform1ui") void glUniform1ui(GLint location, GLuint v0);
JS_WEBGL_FN("glUniform1uiv") void glUniform1uiv(GLint location, GLsizei count, const GLuint *value);
JS_WEBGL_FN("glUniform2f") void glUniform2f(GLint location, GLfloat v0, GLfloat v1);
JS_WEBGL_FN("glUniform2fv") void glUniform2fv(GLint location, GLsizei count, const GLfloat *value);
JS_WEBGL_FN("glUniform2i") void glUniform2i(GLint location, GLint v0, GLint v1);
JS_WEBGL_FN("glUniform2iv") void glUniform2iv(GLint location, GLsizei count, const GLint *value);
JS_WEBGL_FN("glUniform2ui") void glUniform2ui(GLint location, GLuint v0, GLuint v1);
JS_WEBGL_FN("glUniform2uiv") void glUniform2uiv(GLint location, GLsizei count, const GLuint *value);
JS_WEBGL_FN("glUniform3f") void glUniform3f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
JS_WEBGL_FN("glUniform3fv") void glUniform3fv(GLint location, GLsizei count, const GLfloat *value);
JS_WEBGL_FN("glUniform3i") void glUniform3i(GLint location, GLint v0, GLint v1, GLint v2);
JS_WEBGL_FN("glUniform3iv") void glUniform3iv(GLint location, GLsizei count, const GLint *value);
JS_WEBGL_FN("glUniform3ui") void glUniform3ui(GLint location, GLuint v0, GLuint v1, GLuint v2);
JS_WEBGL_FN("glUniform3uiv") void glUniform3uiv(GLint location, GLsizei count, const GLuint *value);
JS_WEBGL_FN("glUniform4f") void glUniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
JS_WEBGL_FN("glUniform4fv") void glUniform4fv(GLint location, GLsizei count, const GLfloat *value);
JS_WEBGL_FN("glUniform4i") void glUniform4i(GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
JS_WEBGL_FN("glUniform4iv") void glUniform4iv(GLint location, GLsizei count, const GLint *value);
JS_WEBGL_FN("glUniform4ui") void glUniform4ui(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
JS_WEBGL_FN("glUniform4uiv") void glUniform4uiv(GLint location, GLsizei count, const GLuint *value);
JS_WEBGL_FN("glUniformMatrix2fv") void glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix2x3fv") void glUniformMatrix2x3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix2x4fv") void glUniformMatrix2x4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix3fv") void glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix3x2fv") void glUniformMatrix3x2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix3x4fv") void glUniformMatrix3x4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix4fv") void glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix4x2fv") void glUniformMatrix4x2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUniformMatrix4x3fv") void glUniformMatrix4x3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
JS_WEBGL_FN("glUseProgram") void glUseProgram(GLuint program);
JS_WEBGL_FN("glVertexAttribPointer") void glVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void *pointer);
JS_WEBGL_FN("glViewport") void glViewport(GLint x, GLint y, GLsizei width, GLsizei height);
