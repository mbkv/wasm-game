...
f32 fminf(f32 a, f32 b) { return a < b ? a : b; }
f32 fmaxf(f32 a, f32 b) { return a > b ? a : b; }
...
typedef struct {
 ...
 Vec2 vec2f(f32 x) { return (Vec2){x, x}; }
 ...
 f32 vec2_cross(Vec2 a, Vec2 b) { return a.x * b.y - a.y * b.x; }

 f32 vec2_length_sq(Vec2 a) { return a.x * a.x + a.y * a.y; }

 f32 vec2_length(Vec2 a) { return sqrtf(vec2_length_sq(a)); }
